...
Route::get('/products-and-r-and-d', 'LandingController@productsAndRAndD')->name('landing.products-and-r-and-d');
Route::get('/business-system', 'LandingController@businessSystem')->name('landing.business-system');
