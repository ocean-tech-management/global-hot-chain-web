...
return [
    ...
    'about_ghc_description' => "GHC Group (Global Hot Chain) is a global health industry supply chain platform founded in 2017 with an initial capital investment of US$100 million and headquartered in New York, USA. By using cutting-edge technology, from high-tech product R&D and production, from procurement to warehousing, from transportation to cross-border e-commerce, GHC Group provides customized and efficient services for partners in the health, beauty, household daily necessities and other industries to meet customers' demands for quality. and the unremitting pursuit of innovation. GHC Group currently has a number of international-level research bases and laboratories, all equipped with advanced equipment and technology. These facilities provide solid support for GHC's R&D team.",
    ...
    'core_description_1' => 'The builder of efficient thermal chains and thermal product systems in the global health industry.',
    'core_description_2' => 'Establish an excellent global supply chain to provide high-quality health products.',
    'core_description_3' => 'A leader in the global health industry, promoting industry prosperity.',

    'ghc_group_value' => 'GHC Group Values',
    'value_1' => 'Integrity',
    'value_2' => 'Altruistic',
    'value_3' => 'Seeking win-win results',
    'value_4' => 'Team',
    'value_5' => 'Focus',
    'value_6' => 'Seek improvement',
    'value_7' => 'Appreciate',
    'value_8' => 'Payout',
    'value_9' => 'Know how to be grateful',

    'ghc_development_achievments' => 'GHC Group’s development achievements',
    'achievement_1' => 'Over 80',
    'achievement_2' => 'Over 60,000+',
    'achievement_3' => 'More than 90,000 units installed',
    'achievement_4' => 'Over 98 billion US dollars',
    ...
    'strength_1' => '20 million households',
    'strength_2' => '2000+',
    'strength_3' => '500+',
    'strength_4' => '19 billion',
    'strength_description_1' => 'Group services cover',
    'strength_description_2' => 'Selected 2000+SKU',
    'strength_description_3' => 'researcher',
    'strength_description_4' => 'Investment in product research and development + base construction',

    'ghc_honor' => 'GHC Group Honors and Qualifications',
    'honor_1' => 'International Standardization Certification',
    'honor_2' => 'Industry Awards',
    'honor_3' => 'Insurance Support',
    'honor_4' => 'International Forum Honors',
    'honor_5' => 'Social Responsibility',
    'honor_6' => 'Historical Honors',
    'honor_description_1' => "GHC Group's products and management system have obtained the ISO 9001 Quality Management System certification from the International Organization for Standardization (ISO), ensuring that every aspect of the group's product design, production, and service processes strictly adheres to international best practices.",
    'honor_description_2' => "GHC Group received the `Health Tech Pioneer Award` at the 2023 Global Health Technology Summit.",
    'honor_description_3' => "GHC Group's product liability insurance is provided by the globally leading insurance company, Munich Re, ensuring the safety and reliability of products worldwide.",
    'honor_description_4' => "At the International Technology Forum, GHC Group was honored with the `Annual Best Innovation Award,` recognizing the group's outstanding performance in technology innovation and product development. GHC Group has been consistently recognized as the `Most Innovative Company Globally` by Forbes magazine since 2018.",
    'honor_description_5' => "GHC Group has been recognized in various industry awards, including the `Annual Best Environmental Technology Award` and `Annual Best Customer Service Award,` reflecting the group's continuous efforts in environmental protection and customer satisfaction.",
    'honor_description_6' => "At the World Economic Forum, GHC Group was named the `Most Promising Global Tech Company`",
    ...
    'product_and_r_and_d' => "Products and Research & Development",
    'ghc_lab' => "GHC Group Research Laboratory",
    'lab_1' => "500+",
    'lab_2' => "11",
    'lab_3' => "25 teams",
    'lab_4' => "$9 billion",
    'lab_description_1' => "Core Research Personnel",
    'lab_description_2' => "Global Research Laboratories",
    'lab_description_3' => "Research & Development Teams",
    'lab_description_4' => "Annual Increase in Research & Development Expenditure",

    'ghc_certification' => "GHC Scientific Strength Authority Certification",
    'ghc_certification_description' => "GHC Group has established a close collaboration with the Stanford University Biotechnology Research Lab. The research achievements of Stanford University experts in the field of biotechnology provide valuable scientific basis for GHC Group's product development.",
    'embl' => "European Molecular Biology Laboratory (EMBL)",
    'embl_description' => "GHC Group has established a close collaboration with the Stanford University Biotechnology Research Lab. The research achievements of Stanford University experts in the field of biotechnology provide valuable scientific basis for GHC Group\'s product development.",

    'business_system' => "Business System",
    'core_business_and_services' => "GHC Group Core Business and Services",
    'core_business_and_services_1' => "Happy Buy E-commerce Platform",
    'core_business_and_services_2' => "AI Healthcare",
    'core_business_and_services_3' => "Chain Formats",
    ...
    'investment_relation' => "Investment Relations",
    'ghc_structure' => "GHC Group Structure",
    'ghc_partners_year_1' => "2017",
    'ghc_partners_title_1' => "Group Establishment and Mission",
    'ghc_partners_description_1' => "GHC Group emerged, establishing a corporate mission focused on R&D in the health industry, laying a solid foundation for subsequent product development and market positioning.",
    'ghc_partners_year_2' => "2018",
    'ghc_partners_title_2' => "Market Breakthrough and Product Innovation",
    'ghc_partners_description_2' => "GHC Group launched the revolutionary `Graphene Vanguard` high-tech product series and established a graphene research institute in Germany. With a unique health philosophy and excellent product quality, it quickly captured the market, achieving rapid market share growth. Annual revenue reached $1 billion.",
    'ghc_partners_year_3' => "2019",
    'ghc_partners_title_3' => "International Market Expansion",
    'ghc_partners_description_3' => "GHC Group further expanded into international markets, with products entering Asia and Europe, receiving a warm welcome from local consumers. Annual revenue surpassed $2 billion.",
    'ghc_partners_year_4' => "2020",
    'ghc_partners_title_4' => "Capital Support and Global Expansion",
    'ghc_partners_description_4' => "GHC Group completed its first round of financing, raising $200 million, providing solid financial support for the group\'s global expansion plans. Annual revenue reached $4.5 billion.",
    'ghc_partners_year_5' => "2021",
    'ghc_partners_title_5' => "Business Expansion and Market Diversification",
    'ghc_partners_description_5' => "GHC Group introduced the `Colorful Radiance` series of health supplements, enriching the group\'s product line and expanding its business scope, bringing new growth points. Annual revenue exceeded $5.8 billion.",
    'ghc_partners_year_6' => "2022",
    'ghc_partners_title_6' => "Industry Leadership and Trend Setting",
    'ghc_partners_description_6' => "GHC Group launched the `Colorful Crystal Beauty` beauty products, leading a new trend in the industry. This not only enhanced the group\'s market competitiveness but also set a new benchmark for the entire health industry. Annual revenue broke the $6.5 billion mark.",
    'ghc_partners_year_7' => "2023",
    'ghc_partners_title_7' => "Continuous Innovation and Future Outlook",
    'ghc_partners_description_7' => "The group added markets in the United Arab Emirates (Dubai), Hong Kong, Thailand, Malaysia, and Europe, totaling 60,000+ open stores globally. These products not only solidified the group\'s leadership in the industry but also drove the group to provide more health solutions for global consumers in the future. Annual revenue reached $7.2 billion!",
    ...
    'footer_description' => "GHC Group (Global Hot Chain) is a global health industry supply chain platform established in 2017, with an initial investment of $100 million, headquartered in New York, USA.",
