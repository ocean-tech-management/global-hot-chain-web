            ...
            @for($i = 6; $i <= 10; $i++)
                <div class="d-flex flex-column">
                    <div class="d-flex">
                        ...
                        <div class="primary-gradient p-3 text-white custom-title" style="border-radius:12px;@if(app()->getLocale() == 'en') min-width:200px; @else min-width:230px;max-width:300px; @endif max-width:70%;width:50vw;">{{ __("landing.ghc_partners_title_$i") }}</div>
                    </div>
                    <div class="d-flex">
                        <div class="mr-4 primary-gradient p-3 text-white" style="border-radius:50%;opacity:0;">2018</div>
                        <div class="p-3 @if(!($i == 10)) custom-line @endif" style="color:#707070;border-radius:12px;width:50vw;font-weight:300;">
