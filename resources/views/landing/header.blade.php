        ...
        <div class="container-fluid nav-header-container">
            <div class="col-auto col-sm-6 col-lg-2 mr-auto pl-lg-0">
                <a class="navbar-brand" href="{{ route('landing.home') }}">
                    <img src="{{asset('landing/images/logo.png')}}"  class="default-logo" alt="">
                    <img src="{{asset('landing/images/logo.png')}}" class="alt-logo" alt="">
                    <img src="{{asset('landing/images/logo.png')}}" class="mobile-logo" alt="">
                </a>
            </div>
            <div class="col-auto menu-order px-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav alt-font">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('landing.products-and-r-and-d') }}" class="nav-link">{{ __('landing.product_and_r_and_d') }}</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('landing.business-system') }}" class="nav-link">{{ __('landing.business_system') }}</a>
                        </li>
                        <li class="nav-item">
