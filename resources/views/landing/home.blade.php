...
{{--                    <img src="images/single-project-page-03-img01.jpg" alt=""/>--}}
                ...
                <div class="col-10 col-lg-7 col-sm-7">
                    ...
                    <div class="position-relative ">
                        <span
                            class="@if(app()->getLocale() == 'en') title-small pr-md-5 @else title-large @endif alt-font font-weight-300 z-index-9 position-relative d-inline-block letter-spacing-4px text-white">{{ __('landing.starts_from') }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-xl-9 col-lg-7 col-sm-8 text-center ">
                    ...
                    <span
                        class="title-small alt-font text-primary font-weight-300 d-block margin-50px-bottom letter-spacing-3px">{{ __('landing.about_ghc') }}</span>
                    <h5 class="text-extra-large2 alt-font text-extra-medium-gray font-weight-300 letter-spacing-minus-1px mb-0"
                        style="line-height: 42px">{{ __('landing.about_ghc_description') }}</h5>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="overlap-height wow animate__fadeIn">
        ...
        <div class="padding-twelve-lr xl-padding-five-lr lg-padding-two-lr xs-no-padding-lr">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    @for($i = 1; $i <= 3; $i++)
                        <div class="col-md-4 d-flex align-items-center flex-column mb-md-0 mb-5 text-center">
    ...
    <section class="p-5">
        ...
        <div class="container-fluid d-flex justify-content-center">
            <div class="row">
                ...
                <div class="col-md-7 px-md-5 px-4">
                    @for($i = 1; $i <= 6; $i++)
